...
fun TmdbNavHost(navController: NavHostController, sharedViewModel: SharedViewModel) {
    NavHost(navController = navController, startDestination = TmdbScreen.MainScreen.route) {
        ...
        composable(TmdbScreen.NowPlaying.route) {
            MoviesScreen(
                "now_playing",
                navController,
                sharedViewModel
        ...
        composable(TmdbScreen.PopularMovies.route) {
            MoviesScreen(
                "popular",
                navController,
                sharedViewModel
        ...
        composable(TmdbScreen.TopRatedMovies.route) {
            MoviesScreen(
                "top_rated",
                navController,
                sharedViewModel
        ...
        composable(TmdbScreen.UpcomingMovies.route) {
            MoviesScreen(
                "upcoming",
                navController,
                sharedViewModel
        ...
        composable(TmdbScreen.AirToday.route) {
            TvScreen(
                "air_today",
                navController,
                sharedViewModel
        ...
        composable(TmdbScreen.OnAir.route) {
            TvScreen(
                "on_the_air",
                navController,
                sharedViewModel
        ...
        composable(TmdbScreen.PopularTv.route) {
            TvScreen(
                "popular_tv",
                navController,
                sharedViewModel
        ...
        composable(TmdbScreen.TopRatedTv.route) {
            TvScreen(
                "top_rated_tv",
                navController,
                sharedViewModel
        ...
        composable(TmdbScreen.MySpace.route) { MySpaceScreen(navController) }
    }
}